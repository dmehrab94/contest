...
int main(){
    ...
    else if(rflag && bflag && !gflag){
        if(rcount>1 && bcount>1){
            cout<<"BGR\n";
        }
        else if(rcount==1 && bcount>1){
            cout<<"GR\n";
        }
        else if(bcount==1 && rcount>1){
            cout<<"BG\n";
        }
        else{
            cout<<"G\n";
    ...
    else if(gflag && bflag && !rflag){
        if(gcount>1 && bcount>1){
            cout<<"BGR\n";
        }
        else if(gcount==1 && bcount>1){
            cout<<"GR\n";
        }
        else if(bcount==1 && gcount>1){
            cout<<"BR\n";
        }
        else{
            cout<<"R\n";
    ...
    else if(rflag && gflag && !bflag){
        if(rcount>1 && gcount>1){
            cout<<"BGR\n";
        }
        else if(rcount==1 && gcount>1){
            cout<<"BR\n";
        }
        else if(gcount==1 && rcount>1){
            cout<<"BG\n";
        }
        else{
            cout<<"B\n";
