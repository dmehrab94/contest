...
int main(){
        ...
        cin>>n>>m;
        if(n>m){
            map<long long int,int>threecount;
            long long int b=3;
            ...
            long long int tot=n;
            while(n!=0){
                if(threecount.find(c)==threecount.end()){
                    n--;
                    maxc=max(maxc,c);
                }
                c+=2;
            ...
            n=tot;
           // cout<<max(maxc,maxb)<<"\n";
            map<long long int,int>twocount;
            b=2;
            long long int maxb1=0;
            for(int i=1;i<=n;++i){
                twocount[b]=1;
                maxb1=max(maxb1,b);
                b+=2;
            ...
            c=3;
            long long int maxc1=0;
            while(m!=0){
                if(twocount.find(c)==twocount.end()){
                    m--;
                    maxc1=max(maxc1,c);
                }
                c+=3;
            }
            cout<<min(max(maxc1,maxb1),max(maxc,maxb))<<"\n";
        }
        else{
            cout<<m*3<<"\n";
        }
