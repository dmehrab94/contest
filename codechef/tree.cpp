...
int vis[105];
int adj[105][105];
void dfs(int l,int src, int dest){
   // printf("now in %d , length %d\n",src,l);
    if(src==dest){
        dis[dest]=l;
        return;
    }
        ...
        for(int k=0;k<=mx;++k){
            ...
            for(int iii=1;iii<=n;++iii){
                for(int jjj=1;jjj<=n;++jjj){
                    printf("%d ",adj[iii][jjj]);
                }
                printf("\n");
            }*/
            int flag=1;
            for(int i=0;i<q;++i){
                int nowsrc=allqs[i].u;
                int nowdest=allqs[i].v;
               ...
               // printf("%d %d\n",nowsrc,nowdest);
                dfs(0,nowsrc,nowdest);
                if((dis[nowdest]%2)!=(allqs[i].sum)){
                    flag=0;
                    break;
                }
            }
